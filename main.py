...
def get_user_input(input_frame):
    ...
    slider = tk.CTkSlider(input_frame, from_=1, to=100, number_of_steps=99,
                          command=lambda value: slider_activity(value, user_input))
    slider.pack(pady=15)
    submit_button = tk.CTkButton(input_frame, text="Submit",
                                 command=lambda: process_user_input(user_input.get(), user_input, input_frame))
...
def get_user_input_config():
    ...
    client_id_label = tk.CTkLabel(input_frame, text="Enter your client_id:", font=("Roboto", 16, "bold"),
                                  text_color="white")
    client_id_label.pack(pady=(40, 0))
    client_id_entry = tk.CTkEntry(input_frame)
    client_id_entry.pack(pady=5)

    client_secret_label = tk.CTkLabel(input_frame, text="Enter your client_secret:", font=("Roboto", 16, "bold"),
                                      text_color="white")
    client_secret_label.pack(pady=(30, 0))
    client_secret_entry = tk.CTkEntry(input_frame)
    client_secret_entry.pack(pady=5)

    redirect_uri_label = tk.CTkLabel(input_frame, text="Enter your redirect_uri:", font=("Roboto", 16, "bold"),
                                     text_color="white")
    redirect_uri_label.pack(pady=(30, 0))
    redirect_uri_entry = tk.CTkEntry(input_frame)
    redirect_uri_entry.pack(pady=5)

    submit_button = tk.CTkButton(input_frame, text="Submit", font=("Roboto", 10), text_color="white",
                                 command=lambda: process_user_input_config(client_id_entry.get(),
                                                                           client_secret_entry.get(),
                                                                           redirect_uri_entry.get(), input_frame))
